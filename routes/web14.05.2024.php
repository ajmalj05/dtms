...
Route::middleware([
    ...
    Route::post('/getPhotos1', [App\Http\Controllers\users\DtmsController::class, 'getPhotos1'])->name('getPhotos1');
    ...
    Route::post('/loadcomplicationDropdown', [App\Http\Controllers\users\MasterDataController::class, 'loaddiagnosisDropdown'])->name('loaddiagnosisDropdown');
    //jdc
    Route::post('/loaddiagnosisDropdown', [App\Http\Controllers\users\MasterDataController::class, 'loadcomplicationDropdown'])->name('loadcomplicationDropdown');
    ...
    //Prescription Print
    Route::get('/prescription-print-data/{print_type?}', [App\Http\Controllers\users\DtmsController::class, 'prescriptionDocument'])->name('prescription-print-data');
