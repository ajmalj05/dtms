        ...
        <div class="text-center target-edit p-3 ">
            <table class="table custom-table customtable_color">
                ...
                <tr>
                    <td>Action Plan</td>
                    <td colspan="2">
                        <textarea cols="2" rows="2" name="action_plan" id="action_plan" class="form-control custom-box" style="height: 78px;">{{ isset($patient_target_details->action_plan)? $patient_target_details->action_plan : ''}}</textarea>
                    </td>
                </tr>
