      ...
      <div class="col-md-12">
        ...
        <div class="profile-tab pb-2">
          <div class="custom-tab-1">
            ...
            <li class="nav-item"><a href="#groups" data-toggle="tab" class="nav-link active show">Test Ranges</a>  </li>
              <li class="nav-item"><a href="#subgroups" data-toggle="tab" class="nav-link">Test Procedure</a>  </li>
                      ...
                      <div class="card-body">
                        ...
                        <div class=" mb-5">
                          ...
                          <form action="#"  name="frm" id="frm" action="" method="POST">
                            ...
                            <input type="hidden" name="hid_met_subid" id="hid_met_subid">


                            <div class="form-group">
                              <label class="text-label">Ranges Name <span class="required">*</span></label>
                              {{-- <input type="text" name="test_range" id="test_range" onKeyPress="return blockSpecialChar(event)" maxlength="250" class="form-control" placeholder="" required> --}}
                                {{-- <small id="test_range_error" class="form-text text-muted error"></small> --}}
                                <select class="form-control js-example-tags" name="test_range" id="test_range">
                                    <option value="">Select</option>
                                    {{-- {{LoadCombo("test_ranges_master","id","test_range",'','where display_status=1 AND is_deleted=0',"order by id desc");}} --}}
                            ...
                            <div class="row">
                                <div class="col-md-11">
                                    <div class="form-group">
                                        <label class="text-label">Ranges in Value </label>
                                        <input type="text" name="ranges_value[]" id="ranges_value"  maxlength="250" class="form-control" placeholder="" required>
                                        <small id="ranges_value_error" class="form-text text-muted error"></small>
                                    </div>
                                    <div id="duplicate_range"></div>
                                </div>

                                <div class="col-md-1 plusbtn showdata">
                                    <div class="form-group">
                                        <label class="text-label" style="opacity:0">Ranges in Value </label>

                                        <i class="fa fa-plus" style="cursor:pointer;position:absolute;bottom:28px" onClick="duplicate();"></i>
                                    </div>
                                </div>
                            </div>
