...
{{--            <td align="left" style="font-weight:bold;width:18%;">{{ ! is_null($data['patient_data']) ? $data['patient_date'] : ''}}</td>--}}
        ...
        <tr>
            ...
            <td>:</td>
            <td align="left" style="font-weight:bold;width:40%;">{{ ! is_null($data['patient_data']) ? $data['patient_data']->name : ''}}   {{ ! is_null($data['patient_data']) ? $data['patient_data']->last_name : ''}} </td>
            <td width="5%" style="text-align:center">&nbsp;</td>
