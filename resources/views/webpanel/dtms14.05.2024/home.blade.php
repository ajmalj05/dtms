                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12  p-0">
                                            <textarea class="form-control" style="height: 40px" placeholder="Remarks" name="remark" id="remark"></textarea>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12  p-0">
                                                ...
                                                <textarea class="form-control"  style="height: 60px"  placeholder="Enter the Alerts" name="alerts_in" id="alerts_in"   rows="5"></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12  p-0">
                                                ...
                                                <label class="text-label">Psychiatric medications</label>
                                        ...
                                        <div class="col-xl-3 col-md-6 mb-2">
                                            <div class="d-flex flex-wrap align-content-center h-100">
                                                <button type="button" class="btn btn-sm btn-primary mt-1" onclick="saveAlertInData(1)">Save</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="element-container">
        ...
        <div class="text-center p-3  float-element">
            <ul class="list-group" style="height:  calc(100vh - 100px);overflow: scroll">
                ...
                <a href="#" class="" onclick="viewPhotos1()"><li class="list-group-item ">CGM</li></a>
