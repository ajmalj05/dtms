...
$(document).ready(function(){
    ...
    $("#visit_lists").dataTable().fnDestroy()
        ...
        'ajax': {
            url: "<?php echo url('/') ?>/get-collection-by-group",
            type: 'POST',
            "data": function(d) {
	  ...
	  //  $( api.column( 0 ).footer() ).html('Total');
            ...
            $( api.column( 2 ).footer() ).html(qtyTotal);
             $( api.column( 3 ).footer() ).html(unit_total);
             $( api.column( 4 ).footer() ).html(discount_amount);
             $( api.column( 5 ).footer() ).html(serviceitemamount);
        },
        "columns": [
            {
                "data": "name",
