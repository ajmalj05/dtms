...
{{--                                        <tbody id="test_data" style="overflow: scroll; height: 278px;">--}}
                                        ...
                                        <tr @if($key->is_outside_lab == 1) class="outsideLab" @else class="insideLab" @endif>
                                            <td @if($key->is_outside_lab == 1) style="color: white;" @endif>{{ $key->TestName }}</td>
